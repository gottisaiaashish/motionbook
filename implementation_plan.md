# MotionBook — Complete Pricing, Subscription, Storage, Referral & Admin System

## Overview

This adds a complete commercial layer on top of the existing AR photo-video platform:
- **6 paid plans** (3 User + 3 Photographer) + **1 Free Demo** + **1 Referral Reward**  
- **Storage tracking** with upload blocking at limits  
